...
$CONFIG = '{"lang":"ru","error_reporting":false,"show_hidden":true,"hide_Cols":true,"calc_folder":true}';
...
//Application Title
define('APP_TITLE', 'Beekeeper Server');
...
$auth_users = array(
    'beekeeper' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //beekeeper@123
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <img src="https://img.icons8.com/fluent/96/000000/administrative-tools.png" alt="">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="../../../" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Beekeeper | Unesell Studio.</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="#hello" target="_blank" class="app-v-title"> Beekeeper Server Admin <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Beekeeper Server Admin <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Beekeeper Server Admin <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Beekeeper Server Admin <br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Beekeeper Server Admin">
    <meta name="author" content="CCP Programmers">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="https://img.icons8.com/fluent/96/000000/administrative-tools.png" type="image/png">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Beekeeper Админпанель';      $tr['en']['AppTitle']           = 'File Manager';
