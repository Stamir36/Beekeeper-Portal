...
<head>
  <meta charset="UTF-8">
  <title>Продовження реєстрації</title>
...
<div class="container">
		...
		<h4 id="banner" style="padding: 0; margin: 0; font-size: 10px; color: cornflowerblue;">Продовження...</h4>
		<h2 id="banner2" style="padding: 0; margin: 0; font-size: 18px; color: darkgoldenrod;">Розкажи про себе.</h2>

			<div id="form-wrap">
				<form action=end_reg.php method=post enctype=multipart/form-data id="FormID">
				<!-- Question One -->
				<div class="question">
					<h1>Як тебе будуть кликати??</h1>
					<input type="text" id="name_form" name="name" placeholder="Не менш 4 символів"></input>
				...
				<!-- Question Three -->
				<div class="question">
					<h1>Останнє, твоє фото на проекті.</h1>
				...
				<div class="completed">
					...
					<h1>Спасибі, дані заповнені!<br/>Приємної роботи!</h1>
					<p>Сподіваємося, вам сподобається наш портал.</p>
				</div>
			</form>
			</div> <!--#form-wrap-->
</div> <!--.container-->
