<?php
    ...
    $result_count = $mysql->query("SELECT COUNT(*) FROM `forum_main_mess` WHERE category = '$c'");
    $count_num = $result_count->fetch_assoc();
    $count = $count_num['COUNT(*)']; // Количество записей

    if($page <= 0){
      header('Location: ?c='.$c.'&page=1');
    }

    $OFFSET = $page * 10 - 10; //С какой записи выводить
    $theme = $mysql->query("SELECT * FROM `forum_main_mess` WHERE category = '$c' ORDER BY Date_Create ASC limit 10 OFFSET $OFFSET");
...
<html>
    <head>
        ...
        <title>Категорії повідомлень - форум пасічників</title>
    ...
    <div class="area" style="margin-top: 56px;">
            ...
            <article class="main" style="height: 100px;">
                <div class="firstcoll" style="height: 100px;">
                  <div style="height: 100px; padding: 15px;">
                    <h1 class="main_text" style="color: #fff; font-weight: 500;">Категорії</h1>
                  </div>
              </div>
            </article>
          ...
          <div style="padding: 0px;">
              <div class="row">
                ...
                <div class="menus">
                  <ul>
                    <a href="?c=Пасічництво"><li <?php if($c == "Пасічництво"){echo("style='background-color: bisque;'");} ?> >Пасічництво</li></a>
                    <a href="?c=Продукти та їжа"><li <?php if($c == "Продукти та їжа"){echo("style='background-color: bisque;'");} ?>>Продукти та їжа</li></a>
                    <a href="?c=Робота та компанії"><li <?php if($c == "Робота та компанії"){echo("style='background-color: bisque;'");} ?>>Робота та компанії</li></a>
                    <a href="?c=Життя"><li <?php if($c == "Життя"){echo("style='background-color: bisque;'");} ?>>Життя</li></a>
                    <a href="?c=Інше"><li <?php if($c == "Інше"){echo("style='background-color: bisque;'");} ?>>Інше</li></a>
                  </ul>
                </div>
                                          ...
                                          <?php                                            
                                            ...
                                            if(count($id_theme) == count($names) && count($id_theme) != 0 && count($names) != 0 ){
                                              ...
                                              <div style='margin: 10px;'>
                                                <a style='color:red; padding: 10px;'>Ще немає створених тем з цією категорією на форумі. Можливо, ти станеш першим?</a>
                                              </div>
                                              ");
                                            }
                        ...
                        <ul class="pagination">
                          ...
                          if($num_page == 1){
                            ...
                            if($page == 1){
                              ...
                              echo("
                              <li class='page-item disabled'>
                                <a class='page-link' onclick='document.location.href = `../category/?c=".$c."&page=".($page - 1)."`;' tabindex='-1'>Попередня</a>
                              </li>
                            ");
                            }else{
                              echo("
                            ...
                            if($page != 1){
                              echo("
                                <li class='page-item' style='cursor: pointer; z-index: 0;'><a class='page-link' onclick='document.location.href = `../category/?c=".$c."&page=".($start_page - 1)."`;'>".($start_page - 1)."</a></li>
                              ");
                            }
                            ...
                            while ($start_page < $end_page && $start_page <= $num_page) {
                              if($start_page == $page){
                                ...
                                echo("
                                  <li class='page-item' style='cursor: pointer; z-index: 0;'><a class='page-link' onclick='document.location.href = `../category/?c=".$c."&page=".$start_page."`;'>".$start_page."</a></li>
                                ");
                              }
                            ...
                            echo("
                              <li class='page-item' style='cursor: pointer;'>
                                <a class='page-link' onclick='document.location.href = `../category/?c=".$c."&page=".($page + 1)."`;' tabindex='-1'>Наступна</a>
                              </li>
                            ");
                            }else{
                              $back = "../category/";
