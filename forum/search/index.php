<?php
    ...
    $result_count = $mysql->query("SELECT COUNT(*) FROM `forum_main_mess` WHERE header LIKE '%$value_search%'");
    ...
    $theme = $mysql->query("SELECT * FROM `forum_main_mess` WHERE header LIKE '%$value_search%' limit 10 OFFSET $OFFSET");
...
<html>
    <head>
        ...
        <title>Пошук - форум пасічників. </title>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="../" style="color: #2344FF; font-weight: 600;"><img src="https://img.icons8.com/fluent/48/000000/comment-discussion.png" style="width: 30px; height: 30px;"/>   Пошук на форумі</a>
    ...
    <div class="area" style="margin-top: 56px;">  
          <div class="wrapper">
            <article class="main">
              <div class="firstcoll">
                <div class="jumbotron">
                  <h1 class="display-4" style="color: #fff; font-weight: 500;">Результати пошуку.</h1>
                  <p class="lead" style="color: #fff; font-weight: 100;">Ви шукали: «<a style="color: yellow;"><?php echo($value_search); ?></a>»</p>
                  <hr class="my-4">
          ...
          <div class="games_card">
            <h2 class="text_banner" style="padding-bottom: 0px;">Результати:</h2>
            
 
            <!-- ТАБЛИЦА ПОИСКА -->  
            <div class="last_theme" style="padding-top: 0px;">
                
                <div class="row" id="cancel-row" style="width: 100%;">
                
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing" style="width: 100%; margin-bottom: 50px;">
                        <div class="widget-content widget-content-area br-6" style="width: 100%;">
                            <div class="table-responsive mb-4 mt-4" style="width: 100%; background-color: rgb(255, 255, 255); padding: 5px; border-radius: 5px;">
                                      <style>
                                        .theme_point:hover{
                                      ...
                                      <?php                                        
                                        ...
                                        if(count($id_theme) == count($names) && count($id_theme) != 0 && count($names) != 0 ){
                                          ...
                                          <div style='margin: 20px;'>
                                            <a style='color:red;'>Нічого не знайдено <img src='https://img.icons8.com/fluent/48/000000/sad.png' width='30px' height='30px'/> <br/>
                                            Спробуйте змінити запит, або створити нову тему.</a>
                                          </div>
                                          ");
                                        }
                    ...
                    <nav style="position: absolute; left: 15px; z-index: 0;">
                        <ul class="pagination">
                          ...
                          if($num_page == 1){
                            ...
                            if($page == 1){
                              ...
                              echo("
                              <li class='page-item disabled'>
                                <a class='page-link' onclick='document.location.href = `../search/?s=".$value_search."&page=".($page - 1)."`;' tabindex='-1'>Попередня</a>
                              </li>
                            ");
                            }else{
                              echo("
                            ...
                            if($page != 1){
                              echo("
                                <li class='page-item' style='cursor: pointer; z-index: 0;'><a class='page-link' onclick='document.location.href = `../search/?s=".$value_search."&page=".($start_page - 1)."`;'>".($start_page - 1)."</a></li>
                              ");
                            }
                            ...
                            while ($start_page < $end_page && $start_page <= $num_page) {
                              if($start_page == $page){
                                ...
                                echo("
                                  <li class='page-item' style='cursor: pointer; z-index: 0;'><a class='page-link' onclick='document.location.href = `../search/?s=".$value_search."&page=".$start_page."`;'>".$start_page."</a></li>
                                ");
                              }
                            ...
                            echo("
                              <li class='page-item' style='cursor: pointer;'>
                                <a class='page-link' onclick='document.location.href = `../search/?s=".$value_search."&page=".($page + 1)."`;' tabindex='-1'>Наступна</a>
                              </li>
                            ");
                            }else{
                              $back = "../search/";
